  ...
  return (
    <div className='w-full flex flex-col items-center'>
      <div className='w-full h-[88px] flex justify-center'>
        <div className='w-full max-w-[1400px] flex justify-between items-center px-4 md:px-0'>
          <a href="/">
          ...
          <div className='flex'>
            {menuItems.map((menu) => (
              <div
                key={menu.title}
                className='px-2 md:px-4 py-[20px]  text-[12px] md:text-[18px] text-center font-bold relative group cursor-pointer'
          ...
          <img src="http://sinjeon.co.kr/img/common/logo2_normal.png" alt="" className='h-8 sm:h-12 hidden md:block' />
        </div>
      </div>
      {activeMenu && (
        <div
